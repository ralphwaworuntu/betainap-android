...
public class ServiceOptionsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle
        ...
        Animation.startZoomEffect( ((ImageView)root.findViewById(R.id.successIcon)) );
        ((TextView)root.findViewById(R.id.booking_id)).setText(  String.format(  getString(R.string.your_booking_is), "#00000"   ) );
