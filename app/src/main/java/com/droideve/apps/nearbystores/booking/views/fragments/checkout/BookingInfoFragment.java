...
import static com.droideve.apps.nearbystores.booking.views.activities.BookingCheckoutActivity.mEvent;
import static com.droideve.apps.nearbystores.booking.views.activities.BookingCheckoutActivity.module;
import static com.droideve.apps.nearbystores.booking.views.activities.BookingCheckoutActivity.module_id;
...
public class BookingInfoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if(mStore != null){
            parserInputViewsForService(root);
        }else if(mEvent != null){
            parserInputViewsForEvent(root);
        }
        ...
        if (requestCode == AUTOCOMPLETE_REQUEST_CODE) {
            if (resultCode == AutocompleteActivity.RESULT_OK) {
                ...
                if(mStore != null){
                    ...
                    for (CF mCF :  BookingCheckoutActivity.mEvent.getCf()  ) {
                        if (getView().findViewWithTag(mCF.getLabel()) != null) {
                            ((AppCompatEditText) getView().findViewWithTag(mCF.getLabel())).setText(place.getName());
                            orderFields.put(mCF.getLabel(), place.getName() + ";" + place.getLatLng().latitude + ";" + place.getLatLng().longitude);
                        }
