...
public class BannerAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        if(o.getTitle().equals("")){
            v.findViewById(R.id.backgoundLayr).setVisibility(View.GONE);
            v.findViewById(R.id.title).setVisibility(View.GONE);
            v.findViewById(R.id.btnOffer).setVisibility(View.GONE);
        }else{
            v.findViewById(R.id.backgoundLayr).setVisibility(View.VISIBLE);
            v.findViewById(R.id.title).setVisibility(View.VISIBLE);
            v.findViewById(R.id.btnOffer).setVisibility(View.VISIBLE);
        }
