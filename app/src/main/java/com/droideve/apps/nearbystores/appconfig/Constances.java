...
public class Constances {
    ...
    public static class API {
        ...
        public static String API_OTP_VERIFFY_CODE = BASE_URL_API+"/user/otpVerifyCode";
        public static String API_OTP_VERIFFY_CODE0 = BASE_URL_API+"/user/otpCheckPhoneValidity";
        public static String API_OTP_SEND_CODE = BASE_URL_API+"/user/otpSendCode";
        public static String API_OTP_SEND_CODE0 = BASE_URL_API+"/user/otpSendCodePhoneValidity";
        ...
        public static String API_EVENT_TICKETS = BASE_URL_API + "/" + API_VERSION + "/event/my_tickets";
        ...
        //Digital Wallet
        public static String API_DIGITAL_WALLET = BASE_URL_API + "/" + API_VERSION + "/digital_wallet/getWallet";
